...
export default class CheckoutProcess {
    ...
    calculateItemSubtotal() {
        ...
        const totals = this.list.map((item) => item.FinalPrice);
        this.itemTotal = totals.reduce((sum, item) => sum + item);
    ...
    displayOrderTotals() {
        let shippingElement = document.querySelector(this.outputSelector + " #shipping");
        let taxElement = document.querySelector(this.outputSelector + " #tax");
        let orderTotalElement = document.querySelector(this.outputSelector + " #orderTotal");
